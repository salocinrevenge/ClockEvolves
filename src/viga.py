...
class Viga(Poligono):
    def __init__(self, pos: np.ndarray, comprimento = 100, largura = 10, massa = 1, elasticity = 0.3, friction = 1.0, space = None, color = (255,255,255,1)) -> None: # largura padrao é 10
